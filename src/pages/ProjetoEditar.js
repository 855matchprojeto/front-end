...
const ProjetoEditar = () => {
  ...
  async function handleEditProject(values) {
    ...
    // imagem (optional)
    if (fields.imagem_projeto) form["imagem_projeto"] = fields.imagem_projeto;
    ...
    deleteArr = deleteArr.map((el) => ({
      id_projetos: pid,
      id_interesses: el.id,
    }));
    insertArr = insertArr.map((el) => ({
      id_projetos: pid,
      id_interesses: el.id,
    }));
        ...
        <>
          ...
          <div className={classes.mediaContainer}>
            <ImageDialog
              ...
              cardMediaImg={
                fields.url_imagem !== null ? fields.url_imagem : ProjectDefault
              }
            />
          </div>
